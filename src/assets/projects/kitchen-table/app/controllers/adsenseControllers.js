...
adsenseControllers.controller("MainController", [
  "$scope",
  "$http",
  function($scope, $http) {
...
adsenseControllers.controller("PeopleController", [
  "$scope",
  "$http",
  function($scope, $http) {
...
adsenseControllers.controller("PeopleDetailController", [
  "$scope",
  "$routeParams",
...
adsenseControllers.controller("FoodController", [
  "$scope",
  "$http",
  function($scope, $http) {
...
adsenseControllers.controller("FoodDetailController", [
  "$scope",
  "$routeParams",
  function($scope, $routeParams) {
...
adsenseControllers.controller("RecipesController", [
  "$scope",
  "$http",
  function($scope, $http) {
...
adsenseControllers.controller("RecipesDetailController", function(
  $scope,
  $routeParams,
  $http
) {
