(function () {
  ...
  //  1% slower.  This didn't change anything because there is only one flow of the page, there is no reflow.  
  //  If there is reflow to the page, then this method might be helpful.
  "use strict";  
