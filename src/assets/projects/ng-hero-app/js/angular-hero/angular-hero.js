(function () {
    'use strict';
    function alAngularHero($animateCss) {
    ...
    var over14 = (angular.version.major >= 1 && angular.version.minor >= 4);
    if (over14) {
        alAngularHero.$inject.push('$animateCss');
    }
    angular.module('alAngularHero', ['ngAnimate'])
        .animation('.hero-transition', alAngularHero);
})();
