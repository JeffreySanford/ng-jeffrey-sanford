...
const routes: Routes = [
  {
    path: 'samples/sample-table',
    component: TableComponent,
    data: { breadCrumb: 'table', title: 'Material Table' },
    pathMatch: 'full',
  },
  {
    path: 'samples/space-video',
    component: SpaceVideoComponent,
    data: { breadCrumb: 'space-video', title: 'Space Video' },
    pathMatch: 'full',
  },
  {
  ...
  {
    path: 'samples/weather',
    component: WeatherComponent,
    data: { breadCrumb: 'weather', title: 'Weather' },
    pathMatch: 'full',
  },
  {
    path: 'samples/inventory',
    component: InventoryComponent,
    data: { breadCrumb: 'inventory', title: 'Inventory' },
    pathMatch: 'full',
  },
  ...
  },
  {
    ...
    data: { breadCrumb: 'design', title: 'Design Dashboard' },
  },
  {
    path: 'development-dashboard',
    component: DevelopmentComponent,
    data: { breadCrumb: 'development', title: 'Development Dashboard' },
  },
